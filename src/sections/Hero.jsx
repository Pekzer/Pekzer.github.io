...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-animated relative overflow-hidden">
      ...
      <div className={`absolute rounded-full mix-blend-multiply filter bg-portfolio-3 pointer-events-none ${isDesktop ? 'bottom-20 left-1/4 w-[400px] h-[400px] blur-3xl opacity-20 pulse-intense' : 'top-[25%] -right-10 w-48 h-32 blur-xl opacity-6'}`} style={isDesktop ? { animationDelay: '2s' } : {}}></div>
