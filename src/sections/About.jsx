...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-white dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className={`absolute top-20 right-10 rounded-full mix-blend-multiply filter bg-portfolio-1 ${isDesktop ? 'w-[500px] h-[500px] blur-3xl opacity-20 pulse-intense' : 'w-40 h-40 blur-xl opacity-10'}`}></div>
      <div className={`absolute bottom-10 left-10 rounded-full mix-blend-multiply filter bg-portfolio-2 ${isDesktop ? 'w-[450px] h-[450px] blur-3xl opacity-20 pulse-intense' : 'w-36 h-36 blur-xl opacity-10'}`} style={isDesktop ? { animationDelay: '1.5s' } : {}}></div>
      <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full mix-blend-multiply filter bg-gradient-to-br from-portfolio-3 to-portfolio-1 ${isDesktop ? 'w-[600px] h-[600px] blur-3xl opacity-10 pulse-intense' : 'w-48 h-48 blur-xl opacity-5'}`} style={isDesktop ? { animationDelay: '0.5s' } : {}}></div>
