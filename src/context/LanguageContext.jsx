...
const translations = {
  es: {
    ...
    about: {
      ...
      connectDescription: 'Estoy siempre abierto a participar en oportunidades de aprendizaje o trabajo, proyectos colaborativos o simplemente hablar sobre programación y tecnología. ¡No dudes en contactarme!',
      sendMessage: 'Envíame un mensaje',
      messageSuccess: '¡Mensaje enviado correctamente! Te responderé pronto.',
      sending: 'Enviando...',
      coursesStats: 'Cursos',
      yearsStudying: 'Años estudiando',
      paragraph1: 'Soy un desarrollador Full Stack, graduado de la Tecnicatura Universitaria en Programación en la Universidad Nacional de Salta.',
  ...
  en: {
    ...
    about: {
      ...
      connectDescription: "I'm always open to participate in learning or work opportunities, collaborative projects or simply talking about programming and technology. Don't hesitate to contact me!",
      sendMessage: 'Send me a message',
      messageSuccess: 'Message sent successfully! I will reply soon.',
      sending: 'Sending...',
      coursesStats: 'Courses',
      yearsStudying: 'Years studying',
      paragraph1: 'I am a Full Stack developer, graduate of the University Programming Technician at Universidad Nacional de Salta.',
