      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex items-center justify-center md:justify-end">
                <a href="https://wa.me/543874118679" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-300">
                  +54 387 4118679
                </a>
              ...
              <div className="flex items-center justify-center md:justify-end">
                <a href="https://maps.app.goo.gl/vGvw4FE5pMjqiXDL9" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-300">
